...
function AdminNavBar({ onSwitchToUsers, onSwitchToReports, onShowPlazoVencimientos, onSwitchToAdmins, onSwitchToAreas }) {
  return (
      ...
      <Container>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="me-auto" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            ...
            <Nav.Link href="" onClick={onSwitchToAreas} className="text-white">ÁREAS</Nav.Link>
            <Nav.Link href="" onClick={onShowPlazoVencimientos} className="text-white">PLAZO VENCIMIENTOS</Nav.Link>
            <Nav.Link href="" onClick={onSwitchToAdmins} className="text-white">ADMINISTRADORES</Nav.Link>
